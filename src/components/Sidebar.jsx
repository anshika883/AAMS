...
export default function Sidebar() {
  ...
  return (
    <aside className="fixed left-0 top-0 z-50 flex h-full w-[260px] flex-col border-r border-outline-variant bg-surface-container-lowest py-lg">
      <div className="mb-xl px-gutter">
        <h1 className="font-headline-sm text-headline-sm font-bold text-primary">AMS Portal</h1>
        <p className="text-label-sm text-secondary">Accommodation Management</p>
      </div>
